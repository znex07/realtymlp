   ...
   <div class="tabs tabs-style-tzoid">
      <nav class="tab-mob">
        <ul>
          ...
          <li class="tab-current"><a href="/dashboard/listing-group" class="tab-fa fa fa-users"><span>Groups</span></a></li>
        </ul>
      </nav>
      <section class="withfilter" style="background-color: #fff">
        @include('main.dashboard.listings.searches.sort-listings')
        @include('main.dashboard.listings.group')
      </section>
      {{-- 
      <div class="content-wrap">
        <section class='tab-section withfilter' id="listings">
          @include('main.dashboard.listings.searches.sort-listings')
          @include('main.dashboard.listings.public')
        </section>
        <section class='tab-section withfilter' id="shared">
          @include('main.dashboard.listings.searches.sort-shared')
          @include('main.dashboard.listings.shared')
        </section>
        <section class='tab-section' id="quick">
          @include('main.dashboard.listings.searches.sort-quick')
          @include('main.dashboard.listings.quick')
        </section>
        <section  class='tab-section withfilter' id="group">
          @include('main.dashboard.listings.searches.sort-groups')
          @include('main.dashboard.listings.group')
        </section>
      </div>
       --}}
