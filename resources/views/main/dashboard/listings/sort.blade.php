...
<div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-body">
            ...
            <div class="form-group col-md-4 mob-tab" style="margin: 0px 0px 0px;">
                    <select id='sm-tab' class="form-control input-sm" >
                        <option value='public'>Public</option>
                        <option value='private'>Private</option>
                        <option value='shared'>Shared to me</option>
            ...
            <div class="pull-right">
                <div class="view-mode">                
                    ...
                    <div class="btn-group">
                        ...
                        <a class="grid_public btn-sm btn btn-primary active" href="#fakelink"><span class="fui-list-small-thumbnails"></span></a>
                    </div>
                </div>    
