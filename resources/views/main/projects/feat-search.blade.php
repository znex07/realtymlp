...
<form method="get" action="/projects">
    <div class="row">
      ...
      <div class="form-group">
            ...
            <div class="col-md-4">
          <select class="form-control" id="search_loc" name="search_loc" onchange="muni(this)">
...
{{--   
    <div class="pull-right">       
      ...
      <a data-filter-name="layout" data-filter-value=".list_view" class="basic-filters list_public btn-sm btn btn-primary active" href="#">City / Municipality</a>
      <a data-filter-name="layout" data-filter-value=".grid_view" class="basic-filters grid_public btn-sm btn btn-primary" href="#"> Developer</a>
